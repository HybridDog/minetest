...
void generate_custom_mipmaps(video::IImage &img)
{
	...
	// TODO: this no longer works since functionality removal in https://github.com/luanti-org/luanti/commit/38c3876c4ef79f310e445cba06af804b1db52fb0
	// maybe generate_custom_mipmaps() can return the mip_maps_data instead of storing it in img and something like regenerateMipMapLevels() could be added to COpenGLCodeTexture.h to set the mipmaps
